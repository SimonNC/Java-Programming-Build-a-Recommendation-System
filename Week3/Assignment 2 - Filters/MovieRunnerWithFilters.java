...
public class MovieRunnerWithFilters {
  ...
  public void printAverageRatings() {
    ...
    ArrayList<Rating> averageRatings = thirdRatings.getAverageRatings(
      minNumOfRatings
    );
    System.out.println(
      "There are " +
  ...
  public void printAverageRatingsByYearAfter() {
    ...
    ArrayList<Rating> averageRatings = thirdRatings.getAverageRatingsByFilter(
      minNumOfRatings,
      yaf
    );
    System.out.println(
  ...
  public void printAverageRatingsByGenre() {
    ...
    for (Rating rating : averageRatings) {
      ...
      System.out.println(
        "Genre(s) : " + MovieDatabase.getGenres(rating.getItem())
      );
    }
  }
  ...
  public void printAverageRatingsByDirectors() {
    ...
    String directorsList =
      "Clint Eastwood,Joel Coen,Martin Scorsese,Roman Polanski,Nora Ephron,Ridley Scott,Sydney Pollack"; // variable
    ...
    System.out.println(
      "There are " +
      averageRatings.size() +
      " movies that were directed " +
      "by either of those directors : " +
      directorsList +
      ", with " +
      minNumOfRatings +
      " or more rating(s) :"
    ...
    for (Rating rating : averageRatings) {
      ...
      System.out.println(
        "Directed by : " + MovieDatabase.getDirector(rating.getItem())
      );
    }
  }
  ...
  public void printAverageRatingsByYearAfterAndGenre() {
    ...
    ArrayList<Rating> avgRatings = thirdRatings.getAverageRatingsByFilter(
      minNumOfRatings,
      af
    );
    System.out.println(
  ...
  public void printAverageRatingsByDirectorsAndMinutes() {
    ...
    String directorsList =
      "Clint Eastwood,Joel Coen,Tim Burton,Ron Howard,Nora Ephron,Sydney Pollack"; // variable
    DirectorsFilter df = new DirectorsFilter(directorsList);
    ...
    System.out.println(
      "There is(are) " +
      avgRatings.size() +
      " movie(s) that were filmed by" +
      " either one of these directors : " +
      directorsList +
      "; and between " +
      minMinutes +
      " and " +
